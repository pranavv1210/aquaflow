  ...
  Widget build(BuildContext context) => FormSection(
    ...
    children: [
      AppTextField(
        ...
        validator:
            (v) => MasterValidators.requiredText(v, fieldName: 'Owner name'),
      ),
      AppTextField(
        label: 'Vehicle Name',
        hintText: 'Required',
        ...
        textInputAction: TextInputAction.next,
        validator:
            (v) => MasterValidators.requiredText(v, fieldName: 'Vehicle name'),
      ),
      AppTextField(
        ...
        textInputAction: TextInputAction.next,
        validator:
            (v) => MasterValidators.requiredText(
              v,
